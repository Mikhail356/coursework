...
## Изменение макета
Для изменения макета следует создать 2 варианта команд. Одна будет проверять есть ли какие-либо изменения в упомянутых на листе адресах, а другая менять указанный лист, удаляя, добавляя нужные URL адреса. 
...
Для проведения дальнейших исследований и проверки результатов стоит реализовать построенный макет на компьютере. На нем планируется проверить функционирование всей системы и в случае недостаточности модели, исправить ее.
