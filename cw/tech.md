# Технологии построения децентрализованных Web-систем — обзор (Пощаманить с ссылками)
## 1. Webmention [1].
...
## 3. Язык разметки Microformats2 [3].
...
# Распределенная сеть the solid ecosystem [4]
